...
class BuildOutput(object):
    ...
    @property
    def path(self):
        """Gets the path of this BuildOutput.  # noqa: E501

        The nix store path  # noqa: E501

        :return: The path of this BuildOutput.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this BuildOutput.

        The nix store path  # noqa: E501

        :param path: The path of this BuildOutput.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BuildOutput):
            return False
